    ...
    <div
      ...
      <form
        ...
        <button
          ...
          class="w-full h-[56px] flex items-center justify-center gap-3 border border-gray-200 rounded-2xl bg-white text-gray-800 hover:shadow-sm transition disabled:opacity-60 disabled:cursor-not-allowed">
          <svg
            aria-hidden="true"
            focusable="false"
            class="w-5 h-5"
            ...
            <path d="M23.5 12.27c0-.82-.07-1.64-.22-2.44H12v4.63h6.46a5.52 5.52 0 0 1-2.39 3.62v2.99h3.86c2.26-2.08 3.57-5.15 3.57-8.8Z" fill="#4285F4" />
            <path d="M12 24c3.24 0 5.97-1.07 7.96-2.93l-3.86-2.99c-1.07.73-2.45 1.15-4.1 1.15-3.16 0-5.83-2.13-6.79-4.99H1.23v3.13A12 12 0 0 0 12 24Z" fill="#34A853" />
            <path d="M5.21 14.23A7.18 7.18 0 0 1 4.83 12c0-.77.13-1.52.38-2.23V6.64H1.23A12 12 0 0 0 0 12c0 1.94.46 3.77 1.23 5.36l3.98-3.13Z" fill="#FBBC05" />
            <path d="M12 4.75c1.77 0 3.36.61 4.61 1.81l3.45-3.45C17.95 1.12 15.22 0 12 0 7.31 0 3.3 2.69 1.23 6.64l3.98 3.13C6.17 6.88 8.84 4.75 12 4.75Z" fill="#EA4335" />
          </svg>
          <span class="text-sm font-medium">
            {{ googleLoading ? $t("Signing in with Google...") : $t("Continue with Google") }}
          </span>
        </button>
